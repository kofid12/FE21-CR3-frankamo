...
export class ProductService {
  private products: Product[] = [
    ...
    { id: 5, name: 'Silver pannel ceilng lamp', image: 'https://cdn.pixabay.com/photo/2014/05/02/12/45/ceiling-lamp-335975_1280.jpg', description: 'comes with high resolution energy saver bulbs', price: 500, availability: true },
